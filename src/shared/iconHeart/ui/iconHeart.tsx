...
import styles from './IconHeart.module.css' // Подключите свои стили
...
export default function IconHeart({
	...
	const [isClicked, setIsClicked] = useState(false || clicked)
	...
	return (
		<>
			{isClicked ? (
				<svg
					className={`${className} ${styles.clicked}`}
					width='48'
					height='48'
					viewBox='0 0 48 48'
					fill='none'
					...
					onClick={handleClick}
				>
					<g id='favorite' clipPath='url(#clip0_1_2180)'>
						<path
							id='Vector'
				...
				<svg
					...
					onClick={handleClick}
				>
					<g id='favorite_border' clipPath='url(#clip0_1_2157)'>
						<path
							id='Vector'
